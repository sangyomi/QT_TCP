...
public:
    ...
    QPushButton *BT_TROT;
    QPushButton *BT_CUSTOM_GAIT1;
    QPushButton *BT_CUSTOM_GAIT2;
    QLineEdit *LE_STAND;
    QLineEdit *LE_TROT;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        BT_TROT = new QPushButton(groupBox_Gait);
        BT_TROT->setObjectName(QString::fromUtf8("BT_TROT"));
        BT_TROT->setGeometry(QRect(118, 39, 91, 51));
        BT_TROT->setFont(font1);
        BT_CUSTOM_GAIT1 = new QPushButton(groupBox_Gait);
        BT_CUSTOM_GAIT1->setObjectName(QString::fromUtf8("BT_CUSTOM_GAIT1"));
        BT_CUSTOM_GAIT1->setGeometry(QRect(223, 39, 91, 51));
        BT_CUSTOM_GAIT1->setFont(font1);
        BT_CUSTOM_GAIT2 = new QPushButton(groupBox_Gait);
        BT_CUSTOM_GAIT2->setObjectName(QString::fromUtf8("BT_CUSTOM_GAIT2"));
        BT_CUSTOM_GAIT2->setGeometry(QRect(328, 39, 91, 51));
        BT_CUSTOM_GAIT2->setFont(font1);
        BT_CUSTOM_GAIT2->setAutoFillBackground(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        BT_TROT->setText(QApplication::translate("MainWindow", "Trot", nullptr));
        BT_CUSTOM_GAIT1->setText(QApplication::translate("MainWindow", "Custom1", nullptr));
        BT_CUSTOM_GAIT2->setText(QApplication::translate("MainWindow", "Custom2", nullptr));
